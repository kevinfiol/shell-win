...
$env.config = {
    ...
    keybindings: [
        ...
        # bind fzf to ctrl + r
        # https://github.com/nushell/nushell/issues/1616#issuecomment-1902732666 +
        # https://github.com/erichdongubler-dotfiles/nushell/blob/1dbd365c190bb69c9d08047de4fa2ad50143e597/config.nu#L238
        {
          name: fuzzy_history
          modifier: control
          keycode: char_r
...
# fnm hack
# https://github.com/Schniz/fnm/issues/463#issuecomment-2009086161
use std "path add"
